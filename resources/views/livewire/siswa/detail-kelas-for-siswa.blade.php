            ...
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600">Guru: {{ $kelas->guru->name }}</p>
                        <p class="text-gray-600">Kode Kelas: {{ $kelas->kode_kelas }}</p>
                    </div>
                    <a href="{{ route('siswa.kelas.index') }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Kembali
                    </a>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Judul</th>
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Deskripsi</th>
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Batas Waktu</th>
                                    <th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6">
                                        <span class="sr-only">Aksi</span>
                                    </th>
                                </tr>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @forelse($tugas as $tugasItem)
                                    <tr>
                                        ...
                                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                            <a href="{{ route('siswa.tugas.submit', $tugasItem->id) }}" class="text-indigo-600 hover:text-indigo-900">Submit</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
